...
class MethodChannelForegroundAppMonitor extends ForegroundAppMonitorPlatform {
  ...
  @visibleForTesting
  final eventChannel =
      const EventChannel('com.example.foreground_app_monitor/foregroundApp');
  ...
  Stream<String> get foregroundAppStream {
    _foregroundAppStream ??= eventChannel
        ...
        .map((event) {
          ...
          if (event is String) {
            ...
            print('ForegroundAppMonitorMethodChannel: Received non-String event: $event');
  ...
  // getPlatformVersion is removed as it's no longer part of the platform interface.
}
